                ...
                <div class="flex flex-row py-2">
                    ...
                    <div class="flex flex-1">
                        ...
                        <select wire:model="locationFilter" id="location"
                            class="block w-full p-4 text-sm text-white border border-gray-300 rounded-lg bg-transparent focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option  class="text-slate-950" value="">All Locations</option>
                    ...
                    <div class="flex flex-1 mx-2">
                        ...
                        <select wire:model="destinationFilter" id="destination"
                            class="block w-full p-4 text-sm text-white border border-gray-300 rounded-lg bg-transparent focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option class="text-slate-950">All Destinations</option>
